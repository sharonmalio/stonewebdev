...
use Appointments\Form\AppointmentsServiceProviderForm;

class AppointmentsServiceProviderFormFactory implements FactoryInterface
{
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        $form = new AppointmentsServiceProviderForm();
